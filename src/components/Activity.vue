			...
			<div :class="makeClass(i)">
				...
				<div
					...
					<a
						...
						:href="activity.url"
						target="_blank"
						class="focus:outline-none rounded py-3 px-4 text-white font-extrabold border border-white flex justify-center items-center text-base hover:bg-gray-400 bg-transparent">
